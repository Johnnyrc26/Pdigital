  ...
  return (
    <div className="bg-gray-900 bg-cover bg-center min-h-screen pb-16">
      ...
      <PCarousel theme="auto" slidesPerPage={1} heading="Most popular">
        ...
        <PButtonTile label="Charging" description="Charging" compact={true} align="top">
          <img
            src="public/assets/2307-bp-porsche-chargingstation-01-0126-230720-64c3da5733f18.webp"
            alt="Some image description"
          />
        </PButtonTile>
        <PButtonTile label="Some label" description="Informative text" compact={true} align="top">
          <img src="public/assets/mission-x-story.webp" alt="Some image description" />
        </PButtonTile>
        <PButtonTile label="Some label" description="Profile" compact={true} align="top">
